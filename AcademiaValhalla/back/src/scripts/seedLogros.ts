...
const LOGROS: Array<{
...
}> = [
    {
        ...
        xp_reward: 50,
        rarity: 'common',
        emblem_url: 'https://fypddbyvseywygkyurdm.supabase.co/storage/v1/object/public/valhalla/emblems/emblema_foro.png',
        display_order: 10,
        is_active: true,
        status: 'published',
    },
    {
        ...
        xp_reward: 25,
        rarity: 'common',
        emblem_url: 'https://fypddbyvseywygkyurdm.supabase.co/storage/v1/object/public/valhalla/emblems/emblema_nutria.png',
        display_order: 11,
        is_active: true,
        status: 'published',
    },
    {
        ...
        xp_reward: 100,
        rarity: 'rare',
        emblem_url: 'https://fypddbyvseywygkyurdm.supabase.co/storage/v1/object/public/valhalla/emblems/emblema_bug.png',
        display_order: 12,
        is_active: true,
        status: 'published',
    },
    {
        ...
        xp_reward: 75,
        rarity: 'common',
        emblem_url: 'https://fypddbyvseywygkyurdm.supabase.co/storage/v1/object/public/valhalla/emblems/emblema_reto.png',
        display_order: 13,
        is_active: true,
        status: 'published',
    },
    {
        ...
        xp_reward: 25,
        rarity: 'common',
        emblem_url: 'https://fypddbyvseywygkyurdm.supabase.co/storage/v1/object/public/valhalla/emblems/emblema_programando.png',
        display_order: 14,
        is_active: true,
        status: 'published',
    },
