...
import rutaCazaTroll from './rutas/rutaCazaTroll.js';
import rutaSagas from './rutas/rutaSagas.js';
import rutaTorneos from './rutas/rutaTorneos.js';
import rutaPadrinazgo from './rutas/rutaPadrinazgo.js';
import rutaShowcase from './rutas/rutaShowcase.js';
...
app.use('/api/v1/caza-bichillo', rutaCazaTroll);
app.use('/api/v1/roadmap', rutaSagas);
app.use('/api/v1/tournaments', rutaTorneos);
app.use('/api/v1/mentorship', rutaPadrinazgo);
app.use('/api/v1/showcase', rutaShowcase);
