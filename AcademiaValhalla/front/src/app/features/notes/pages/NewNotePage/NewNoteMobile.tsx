                        ...
                        {note.source === 'personal' && (
                            <div className="shrink-0 flex items-center gap-1.5">
                                <Link
                                    ...
                                    className="flex items-center gap-1 px-2.5 py-1.5 font-mono text-[10px] uppercase tracking-[0.15em] border border-emerald-500/40 text-emerald-600 dark:text-emerald-400 active:bg-emerald-500/[0.08] transition-colors"
