...
/**
 * A4 · Caza del Troll — el usuario debe encontrar el bug que la IA introdujo.
 * Página autocontenida (sin dependencias de Monaco) para máxima portabilidad.
 */
        ...
        <div className="max-w-3xl mx-auto px-5 py-8">
            <header className="mb-6">
                ...
                <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">
                    La IA ha escondido <strong>un bichillo (bug)</strong> en este código. Encuéntralo: marca la línea sospechosa y explica el fallo.
                </p>
            </header>
