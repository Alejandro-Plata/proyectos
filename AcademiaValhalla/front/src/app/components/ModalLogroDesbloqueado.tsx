...
export default function ModalLogroDesbloqueado({ achievement, visible, onClose }: Props) {
    ...
    const rarity = achievement.achievement.rarity as keyof typeof RAREZA_CONFIG;
    const config = RAREZA_CONFIG[rarity] ?? RAREZA_CONFIG.common;
