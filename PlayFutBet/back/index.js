...
app.post('/api/register', async (req, res) => {
    try {
        ...
        // Generate DiceBear avatar URL using username as seed
...
app.get('/api/matches/:id', (req, res) => {
    ...
    // Optimize response: Remove events if match is pending (should be empty anyway, but just in case)
    const matchDetail = {
        ...match,
        events: match.status === 'pending' ? [] : match.events
    };
